...
#ifdef __i386__
static CONST char __snan[8] = __snan_bytes;
#define	_SNAN	(*(CONST double *) __snan)
static CONST char __qnan[8] = __qnan_bytes;
#define	_QNAN	(*(CONST double *) __qnan)
static CONST char __snanf[4] = __snanf_bytes;
#define	_SNANF	(*(CONST float *) __snanf)
static CONST char __qnanf[4] = __qnanf_bytes;
#define	_QNANF	(*(CONST float *) __qnanf)
#endif
#endif	/* GCC.  */
