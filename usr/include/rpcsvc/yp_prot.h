/*      @(#)yp_prot.h 1.15 90/01/03 Copyr 1990 Sun Microsystems, Inc */
...
extern bool_t xdr_ypdomain_wrap_string __P (());
extern bool_t xdr_ypmap_wrap_string __P (());
...
extern bool_t xdr_ypreq_xfr __P (());
...
extern bool_t xdr_yp_inaddr __P ((XDR *__xdrs, struct in_addr * __objp));
extern bool_t xdr_ypmap_parms __P (());
extern bool_t xdr_ypowner_wrap_string __P (());
extern bool_t xdr_yppushresp_xfr __P (());
...
extern bool_t xdr_peername __P ((XDR *__xdrs, char * __objp));
extern bool_t xdr_mapname __P ((XDR *__xdrs, char * __objp));
