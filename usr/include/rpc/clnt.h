 ...
 */
extern CLIENT * clnt_create __P ((char *__host, u_long __prog,
		u_long __vers, char *__prot));
...
extern int callrpc __P ((char *__host,
		u_long __prognum, u_long __versnum, u_long __procnum,
		xdrproc_t __inproc, char *__in,
...
extern int getrpcport __P ((char * __host, u_long __prognum,
